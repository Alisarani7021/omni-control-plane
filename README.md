...
- «🌐 مرکز DNS» بخش کاملاً مستقل: اسکن رنج برای یافتن DNSهای سالم با پرسش واقعی TCP/53 و بروزرسانی خودکار هر ۳۰ دقیقه، تست مسمومیت با انتخاب اپراتور/شهر و فرمان آمادهٔ کپی، و سازنده‌های Master DNS (DoH + رکورد SVCB)، White DNS (لیست سفید TXT روی zone خود کاربر) و Slipstream — همگی با اتصال Cloudflare خود کاربر.
